...
import QuickAnswerTable from "./Tables";
import { connect } from "react-redux";

export const dummyData = [
  {
    name: "Danh sách câu trả lời nhanh",
    content: <QuickAnswerTable />,
  },
];


class QuickAnswer extends Component {
    constructor(props) {
        super(props);
...
export default connect(mapStateToProps, mapDispatchToProps)(QuickAnswer);
